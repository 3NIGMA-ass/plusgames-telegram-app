...
export function CardTransferConfirmationDialog({
  ...
  useEffect(() => {
    ...
    // Проверяем, превышает ли сумма порог для пополнения только через менеджера
    if (
      appConfig?.manager_only_threshold &&
      newAdjustedAmount >= appConfig.manager_only_threshold
    ) {
      setSelectedCard(undefined);
      setCardError(null);
      setIsLoadingCard(false);
    ...
    // Проверяем, попадает ли сумма в диапазон для использования API
    const isAmountInApiRange = appConfig?.api_amount_ranges?.some(
      (range) =>
        newAdjustedAmount >= range.min && newAdjustedAmount <= range.max,
    );
    ...
    if (appConfig?.useapiforcard && isAmountInApiRange) {
      fetchCardDetails();
    } else {
      const card = cards.find(
        (card) =>
          card.min_amount <= newAdjustedAmount &&
          newAdjustedAmount <= card.max_amount,
      );
      setSelectedCard(card);
      setIsLoadingCard(false);
      setCardError(card ? null : 'Подходящая карта не найдена.');
    }
  }, [isOpen, user?.telegram_id, cards, appConfig, amount]);
                ...
                <div className="relative flex h-[164px] max-w-full shrink-0 overflow-hidden rounded-xl bg-zinc-800 p-4 before:absolute before:bottom-0 before:right-0 before:h-full before:w-[196px] before:bg-[url('data:image/png;base64,')] before:bg-cover before:content-[''] lg:max-w-[277px] xl:max-w-[343px]">
                  <div className='flex h-full max-w-36 flex-col items-start'>
                    ...
                    <p className='text-sm leading-relaxed tracking-tight text-zinc-400'>
                      Пополнение возможно только через менеджера.
                    </p>
                  </div>
                  <Image
